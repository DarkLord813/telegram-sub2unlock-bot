...
# Fixed for Python 3.11 - Proper Event Loop Handling
# ============================================
...
async def main():
    ...
    # ============================================
    # FIX: Properly initialize and start polling
    # ============================================
    await application.initialize()
    await application.start()
    
    # Start polling with the correct parameters
